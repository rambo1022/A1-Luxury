...
exports.sendEmail = functions.https.onCall(async (payload, context) => {
    ...
    const REFRESH_TOKEN = '1//04MFrTYxCjKIbCgYIARAAGAQSNwF-L9IrpIQMGia6WnqG1qzrwerz5zLJ4RLvV0rSSBMihVjYSlHn8rJWJa8jqLeJnkIHoJyEfqQ';
    ...
    async function sendMail() {
      try {
        ...
        const mailOptions = {
          ...
          to: 'a1luxurydetailing6@gmail.com',
          subject: `${userSubject}`,
          text: `${message}`,
          html: `<h1>${message}</h1>`,
        };
